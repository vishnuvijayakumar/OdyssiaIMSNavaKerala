  ...
  if(isset($_GET['print'])){
   ...
   // validate_fields($req_dates);
	...
	if(isset($_GET['excel'])) {
        ...
        $results1      = join_stockaudit_product_report_export();
        ...
        $filename = "IMS_ProductStockAuditReport_export".date('Ymd') . ".xls";
   ...
   // else:
    ...
    redirect('stock_Audit_product_report.php.php', false);
  }
?>
<!doctype html>
<html lang="en-US">
 <head>
   ...
   <title>Product Stock Audit Report Print</title>
...
<body>
  ...
  <?php
        ...
        redirect('stock_Audit_product_report.php', false);
     endif;
  ?>
</body>
</html>
