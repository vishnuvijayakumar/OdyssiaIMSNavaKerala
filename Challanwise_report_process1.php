<?php
$page_title = 'Challan Wise Stock Report';
$results = '';
...
<?php
  ...
  if(isset($_GET['planno'])){
   ...
   // else:
    ...
    $session->msg("d", "Select Challan No");
    redirect('Challanwise_report_process.php', false);
  }
?>
<!doctype html>
<html lang="en-US">
 <head>
   ...
   <title>Challanwise Report Print</title>
    ...
    <div class="row">
     ...
     <div class="panel panel-default">
       <div class="panel-heading text-center">
           <h4 class="text-center">Inventory Management System - Challanwise Stock Entry Report</h4>
           <span class="text-center"><strong> Challan Id: <?php if(isset($planno)){echo $planno;}?> </strong></span>
       </div>
