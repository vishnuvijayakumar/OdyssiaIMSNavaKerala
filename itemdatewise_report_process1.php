  ...
  <div class="row">
    ...
    <div class="col-md-12">
      ...
      <div class="pull-right">
		   <a href="itemdatewise_report_process.php?excel=1&start-date=<?php echo $start_date; ?>&end-date=<?php echo  $end_date; ?>&product_name=<?php echo  $product_name; ?>"class="btn btn-primary">Export</a>
           <a href="itemdatewise_report_process.php?start-date=<?php echo $start_date; ?>&end-date=<?php echo  $end_date; ?>&product_name=<?php echo  $product_name; ?>" target="_blank" class="btn btn-primary">Print</a>
         </div>
         <?php } ?>
      <div class="panel-heading ">
         <h4 class="text-center">Datewise Stock Report</h4>
        </div>
