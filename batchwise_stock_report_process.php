   ...
   // validate_fields($req_dates);
    ...
    //if(empty($errors)):
	  ...
	  if(isset($_GET['excel'])) {
        ...
        $filename = "IMS_BatchStock_export_".date('Ymd') . ".xls";
...
<html lang="en-US">
 <head>
   ...
   <title>Product Barcodes Print</title>
    ...
    <div class="row">
     ...
     <div class="panel panel-default">
       <div class="panel-heading text-center">
           <h4 class="text-center">Inventory Management System - Batchwise Product Stock Report</h4>
           <span class="text-center"><strong> Overall batch Stock for a Product </strong></span>
       </div>
