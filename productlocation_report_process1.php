<?php
  $page_title = 'Product Location Details';
  ...
  <div class="row">
    ...
    <div class="col-md-12">
      ...
      <div class="pull-right">
		   <a href="productlocation_report_process.php?excel=1&product_name=<?php echo  $product_name; ?>" class="btn btn-primary">Export</a>
           <a href="productlocation_report_process.php?product_name=<?php echo  $product_name; ?>" target="_blank" class="btn btn-primary">Print</a>
         </div>
         <?php } ?>
      <div class="panel-heading ">
         <h4 class="text-center">Product Location Report</h4>
        </div>
