<?php
  $page_title = 'Location Prodect Details';
  ...
  <div class="row">
    ...
    <div class="col-md-12">
      ...
      <div class="pull-right">
		   <a href="locationwise_report_process.php?excel=1&product_name=<?php echo  $product_name; ?>" class="btn btn-primary">Export</a>
           <a href="locationwise_report_process.php?product_name=<?php echo  $product_name; ?>" target="_blank" class="btn btn-primary">Print</a>
         </div>
         <?php } ?>
      <div class="panel-heading ">
         <h4 class="text-center">Locationwise Barcode List</h4>
        </div>
