<?php
  $page_title = 'Challan wise Stock Details';
  ...
  if(isset($_POST['submit'])){
    ...
    if(empty($errors)):
      ...
      redirect('Challanwise_report.php', false);
    endif;
  ...
  <div class="row">
    ...
    <div class="col-md-12">
      ...
      <div class="pull-right">
           <a href="Challanwise_report_process1.php?planno=<?php echo $_POST['planno']; ?>" target="_blank" class="btn btn-primary">Print</a>
         </div>
         <?php } ?>
      <div class="panel-heading ">
         <h4 class="text-center">Challanwise Stock Entry Report</h4>
        </div>
