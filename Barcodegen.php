...
//echo $barcodeuique;die();
    $regenbarcode=$barcodeuique;
	      $content1.=$regenbarcode."\r\n";
    //$barcodefile=getenv("HOMEDRIVE").getenv("HOMEPATH")."/Desktop"."/Generated_barcode.txt";
    $barcodefile=$_SERVER["DOCUMENT_ROOT"]."/CaltechIMS/IMSBarcode/barcodes.txt";
 ...
 if(isset($_GET['exportbarcodefile'])){
     $file=$_SERVER["DOCUMENT_ROOT"]."/CaltechIMS/IMSBarcode/barcodes.txt";
     $namefile="https://simplepro.in/CaltechIMS/IMSBarcode/barcodes.txt";
        ...
        <div class="panel-body">
          <form method="post" action="Barcodegen.php">
            <div class="form-group">
                ...
                <option value="FU">Finished Upper</option>
                <option value="CHM">Chemicals</option>
                <option value="Pack">Packing Materials</option>
                <option value="Cons">Consumables</option>
                </select>
