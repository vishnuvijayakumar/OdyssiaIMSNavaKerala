...
for($idx = 0; $idx < count($arr); $idx++){
	...
	$UnitName =  $obj["unitNameB"];
		$UserName = $obj["userB"];
		 ...
		 $sqlselect = "SELECT a.Barcode,st.ProductId,b.ItemName,st.CategoryId,st.SubCategoryId,'".$StockType."','".$Quantity."' as 'Quantity',e.UomId,f.LocationId,g.UnitId,'".$PlanNo."', h.id,a.Quantity as 'AvailableQ',e.ConversionValue as 'ConvVal'
 ...
 and e.UomSubType = '".$UomSubType."' and g.UnitName='".$UnitName."' and h.username ='".$UserName."' limit 1";
