<?php
$page_title = 'Product Barcode List';
$results = '';
   ...
   // validate_fields($req_dates);
    ...
    //if(empty($errors)):
	  ...
	  if(isset($_GET['excel'])) {
        ...
        $filename = "IMS_ProductBarcode_export_".date('Ymd') . ".xls";
    ...
    <div class="row">
     ...
     <div class="panel panel-default">
       <div class="panel-heading text-center">
           <h4 class="text-center">Inventory Management System - Product Barcode List</h4>
           <span class="text-center"><strong> Overall Barcode for a Product </strong></span>
       </div>
