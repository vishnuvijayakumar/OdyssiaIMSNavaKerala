<?php
  $page_title = 'Batch Stock Details';
  ...
  if(isset($_POST['submit'])){
    ...
    if(empty($errors)):
      ...
      $results = find_batch_stock($product_name);
      //print_r($results);die;
    else:
      $session->msg("d", $errors);
      redirect('bachwise_stock_report.php', false);
    endif;
  ...
  <div class="row">
    ...
    <div class="col-md-12">
      ...
      <div class="pull-right">
		   <a href="batchwise_stock_report_process.php?excel=1&product_name=<?php echo  $product_name; ?>" class="btn btn-primary">Export</a>
           <a href="batchwise_stock_report_process.php?product_name=<?php echo  $product_name; ?>" target="_blank" class="btn btn-primary">Print</a>
         </div>
         <?php } ?>
      <div class="panel-heading ">
         <h4 class="text-center">Product Batch Stock</h4>
        </div>
          ...
          <table class="table table-bordered" id="stocktable">
            <thead>
              <tr>
                ...
                <th class="text-center" style="width: 100px;"> Locations </th>
              </tr>
            </thead>
            <tbody>
              <?php $TotalQty=0; foreach ($results as $stock):?>
              <tr>
