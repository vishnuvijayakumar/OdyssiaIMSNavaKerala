...
<?php
 if(isset($_POST['add_cat'])){
   ...
   $userid = current_user();
     $p_userid = $userid['id'];
   if(empty($errors)){
      $sql  = "INSERT INTO categorydetails (CategoryName,id)";
      $sql .= " VALUES ('{$cat_name}','{$p_userid}')";
      if($db->query($sql)){
              ...
              <?php foreach ($all_categories as $cat):?>
                <tr>
                    ...
                    <td class="text-center">
                      <div class="btn-group">
                        <a href="edit_categorie.php?CategoryId=<?php echo (int)$cat['CategoryId'];?>"  class="btn btn-xs btn-warning" data-toggle="tooltip" title="Edit">
                          <span class="glyphicon glyphicon-edit"></span>
                        </a>
                        <a href="delete_categorie.php?CategoryId=<?php echo (int)$cat['CategoryId'];?>"  class="btn btn-xs btn-danger" data-toggle="tooltip" title="Remove">
